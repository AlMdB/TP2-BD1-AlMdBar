...
ExtendibleHashTable::ExtendibleHashTable(const std::string& _file_path, size_t _bucket_cap, Logger* _logger):
                    logger(_logger),
    ...
    sec_storage.open(file_path + DATA_FILE_SUFFIX, std::ios::in | std::ios::out | std::ios::binary);
